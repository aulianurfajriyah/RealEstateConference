...
export default class PauseOnHoverPhone extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="">
        <div className="">
          <div className="grid gap-4 justify-items-center py-4 ">
            <div className="title font-roxboroughmd text-5xl max-xs:text-[20px]">
              Our Speakers
            </div>
            <p className="font-manrope text-[15px] text-center leading-[24px] w-4/5 max-xs:text-[12px]">
        ...
        <div className="flex justify-center py-5">
          {" "}
          <div className="button-swipe  gap-2 flex justify-center">
            <button
